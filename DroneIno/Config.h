...
// PID:
//              (ROLL)
#define PID_P_GAIN_ROLL             1.4                      //Gain setting for the roll P-controller (1.3)
...
//              (YAW)
#define PID_P_GAIN_YAW              2.0                      //Gain setting for the pitch P-controller. (2.0)
#define PID_I_GAIN_YAW              0.04                     //Gain setting for the pitch I-controller. (0.04)
